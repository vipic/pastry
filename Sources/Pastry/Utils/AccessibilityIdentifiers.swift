enum AccessibilityIdentifiers {
    enum Overlay {
        ...
        static let naturalLanguageSearchButton = "overlay.natural-language-search-button"
    ...
    enum Settings {
        ...
        static let trayPlacementPicker = "settings.tray-placement-picker"
        ...
        static let appleIntelligenceToggle = "settings.apple-intelligence-toggle"
